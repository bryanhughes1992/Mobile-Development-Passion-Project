                ...
                c => new
                    {
                        ...
                        RoomLength = c.Decimal(nullable: false, precision: 18, scale: 2),
                        RoomWidth = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Demolition = c.Boolean(nullable: false),
                        NewWalls = c.Int(nullable: false),
                        Drywall = c.String(),
                        Floor = c.String(),
                        Image = c.Binary(),
