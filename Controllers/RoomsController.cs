...
namespace PASSION_PROJECT_MVP.Controllers
{
    public class RoomsController : Controller
    {
        ...
        {
            var rooms = db.Rooms.Include(r => r.House);
        ...
        {
            ViewBag.HouseId = new SelectList(db.Houses, "HouseId", "Address");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "RoomId,RoomLength,RoomWidth,Demolition,NewWalls,DrywallRepair,DrywallInstallation,FloorInstallation,NewWindows,NewDoors,HouseId")] Room room)
        {
            ...
            ViewBag.HouseId = new SelectList(db.Houses, "HouseId", "Address", room.HouseId);
            return View(room);
        }
